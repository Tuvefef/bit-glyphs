...
#define G_EIGHT_PATTERN     0x0e8ba2eu   // '8'
#define G_PERCENT_PATTERN   0x1359359u   // '%'
#define G_UNUSED_PATTERN    0x0000000u   // (not used)
#define G_BIG_O_PATTERN     0x0e8c62eu   // 'O'
#define G_SMALL_O_PATTERN   0x0d9c5c0u   // 'o'
